# swintransformer 80 0.0005 87.0%
...
class BasicLayer(nn.Module):
    ...
    def __init__(
            ...
            drop_path=0., norm_layer=nn.LayerNorm, downsample=nn.Identity()):
    ...
    def __init__(
        ...
        for i in range(self.num_layers):
            layers += [BasicLayer(
                ...
                downsample=PatchMerging if (i < self.num_layers - 1) else nn.Identity()
            )]
